...
(function(blocks, element, components, editor, $) {
  ...
  var iconEl = el('svg', {width: 24, height: 24},
      el('path', {fill:"#212120", d:"M22.9,3.2H8.1C7.5,3.2,7,2.4,7,1.6C7,0.7,7.5,0,8.1,0h14.8C23.5,0,24,0.7,24,1.6\n" +
            "\t\tC24,2.4,23.5,3.2,22.9,3.2L22.9,3.2z"}),
      el('path', {fill:"#212120", d:"M22.9,16.7H8.1C7.5,16.7,7,16,7,15.1c0-0.8,0.5-1.6,1.1-1.6h14.8c0.6,0,1.1,0.7,1.1,1.6\n" +
            "\t\t\tC24,15.9,23.5,16.7,22.9,16.7L22.9,16.7z"}),
      el('path', {fill:"#212120", d:"M14,22.8V7.2C14,6.6,14.7,6,15.5,6C16.3,6,17,6.5,17,7.2v15.6c0,0.6-0.7,1.2-1.5,1.2\n" +
