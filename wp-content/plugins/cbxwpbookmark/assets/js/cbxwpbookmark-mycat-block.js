...
(function(blocks, element, components, editor, $) {
  ...
  var iconEl = el('svg', {width: 24, height: 24},
      el('path', {fill:"#212120", d: 'M8.3,15.7H2.5c-0.4,0-0.7-0.3-0.7-0.7V9.1c0-0.4,0.3-0.7,0.7-0.7h5.9c0.4,0,0.7,0.3,0.7,0.7V15\n' +
            '\t\tC9.1,15.4,8.7,15.7,8.3,15.7z M3.2,14.2h4.4V9.8H3.2V14.2z'}),
      el('path', {fill:"#212120", d: 'M21.6,20.9h-5.9c-0.4,0-0.7-0.3-0.7-0.7v-5.9c0-0.4,0.3-0.7,0.7-0.7h5.9c0.4,0,0.7,0.3,0.7,0.7v5.9\n' +
            '\t\tC22.3,20.5,22,20.9,21.6,20.9z M16.4,19.4h4.4V15h-4.4V19.4z'}),
      el('path', {fill:"#212120", d: 'M21.6,9.1h-5.9c-0.4,0-0.7-0.3-0.7-0.7V2.5c0-0.4,0.3-0.7,0.7-0.7h5.9c0.4,0,0.7,0.3,0.7,0.7v5.9\n' +
            '\t\tC22.3,8.8,22,9.1,21.6,9.1z M16.4,7.6h4.4V3.2h-4.4V7.6z'}),
      el('path', {fill:"#212120", d: 'M12,23.8c-0.4,0-0.7-0.3-0.7-0.7V1c0-0.4,0.3-0.7,0.7-0.7s0.7,0.3,0.7,0.7v22.1\n' +
            '\t\tC12.8,23.5,12.4,23.8,12,23.8z'}),
      el('path', {fill:"#212120", d: 'M12,12.8H8.3c-0.4,0-0.7-0.3-0.7-0.7s0.3-0.7,0.7-0.7H12c0.4,0,0.7,0.3,0.7,0.7S12.4,12.8,12,12.8\n' +
            '\t\tz'}),
      el('path', {fill:"#212120", d: 'M15.7,6.2H12c-0.4,0-0.7-0.3-0.7-0.7c0-0.4,0.3-0.7,0.7-0.7h3.7c0.4,0,0.7,0.3,0.7,0.7\n' +
            '\t\tC16.4,5.8,16.1,6.2,15.7,6.2z'}),
      el('path', {fill:"#212120", d: 'M15.7,17.9H12c-0.4,0-0.7-0.3-0.7-0.7c0-0.4,0.3-0.7,0.7-0.7h3.7c0.4,0,0.7,0.3,0.7,0.7\n' +
