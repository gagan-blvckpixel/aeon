<?php
	...
	class CBXWPBookmarkHelper {
		...
		public static function customizer_default_values() {
			$customizer_default = array(
				...
				'cbxwpbookmark-mycat' => array(
					'title'          => esc_html__('My Bookmark Categories', 'cbxwpbookmark'), //if empty title will not be shown
					'order'          => "ASC", //DESC, ASC
		...
		public static function show_cbxbookmark_btn( $object_id = 0, $object_type = null, $show_count = 1, $extra_wrap_class = '', $skip_ids = '', $skip_roles = '' ) {
					...
					$cbxwpbkmark .= ' <div  data-type="' . $object_type . '" data-object_id="' . $object_id . '" class="cbxwpbkmarklistwrap" id="cbxwpbkmarklistwrap-' . $object_id . '">
                            ...
                            <div class="cbxwpbkmark_cat_book_list">
                                <div class="cbxlbjs cbxwpbkmark-lbjs">
									...
									<ul class="cbxlbjs-list cbxwpbkmarklist" style="" data-type="' . $object_type . '" data-object_id="' . $object_id . '">
									</ul>
								</div>
                            </div>';
						...
						$cbxwpbkmark .= '
                            	...
                            	<div class="cbxwpbkmark_cat_add_form">
                                    ...
                                    <div class="cbxwpbkmark-field-wrap">
                                        <input required placeholder="' . esc_html__( 'Type Category Name', 'cbxwpbookmark' ) . '" type="text" class="cbxwpbkmark-field cbxwpbkmark-field-text  cbxwpbkmark-field-cat" />
                                        <input required type="hidden" name="cbxwpbkmark-field-catid" class="cbxwpbkmark-field-catid" value="0" />
                                    </div>
                                    <div class="cbxwpbkmark-field-wrap">                                                                               
                                        <div class="cbxwpbkmarkaddnewcatselect ">
                                ...
                                <div class="cbxwpbkmark_cat_edit_form">
                                	<p class="cbxwpbkmark-form-note"> </p>
                                    <div class="cbxwpbkmark-field-wrap">
                                        <input required placeholder="' . esc_html__( 'Category Name', 'cbxwpbookmark' ) . '" type="text" class="cbxwpbkmark-field cbxwpbkmark-field-text  cbxwpbkmark-field-cat" />
                                        <input required type="hidden" name="cbxwpbkmark-field-catid" class="cbxwpbkmark-field-catid" value="0" />
                                    </div>
                                    <div class="cbxwpbkmark-field-wrap">                                        
                                        <div class="cbxwpbkmarkmanagecatselect">
                                        	<select class="cbxwpbkmark-field cbxwpbkmark-field-select  cbxwpbkmark-field-privacy cbxwpbkmark-field-privacy_' . $object_id . '">
	                                            <option value="1">' . esc_html__( 'Public Category', 'cbxwpbookmark' ) . '</option>
	                                            <option value="0">' . esc_html__( 'Private Category', 'cbxwpbookmark' ) . '</option>
										  	</select>                                          
			...
			$cbxwpbkmark = '<div data-object_id="' . $object_id . '" class="cbxwpbkmarkwrap cbxwpbkmarkwrap_' . $bookmark_mode . ' cbxwpbkmarkwrap-' . $object_type . ' ' . $extra_wrap_class . '">' . $cbxwpbkmark . '</div>';

			//$cbxwpbkmark = '<div data-object_id="' . $object_id . '" class="cbxwpbkmarkwrap cbxwpbkmarkwrap-' . $bookmark_mode . ' cbxwpbkmarkwrap-' . $object_type . ' ' . $extra_wrap_class . '">' . $cbxwpbkmark . '</div>';
		...
		public static function cbxbookmark_most_html( $instance, $attr = array() ) {
			...
			<ul class="cbxwpbookmark-mostlist <?php echo esc_attr( $ul_class ); ?>">
				<?php
					...
					if ( $display == 0 ) {
						...
						foreach ( $items as $item ) {
							...
							if ( $allowedit || $show_bookmarks ) {
								...
								$list_data_attr .= ' data-userid="' . $userid . '"   data-privacy="' . $item->privacy . '" data-name="' . $item->cat_name . '" ';
							}
							...
							$output .= '<li class="cbxbookmark-category-list-item ' . $sub_list_class . '" ' . $list_data_attr . '> <a href="' . esc_url( $cat_pernalink ) . '" class="cbxlbjs-item-widget" data-privacy="' . $item->privacy . '">' . $item->cat_name . '</a>' . $show_count_html . $action_html . '</li>';
						}//end for each
						...
						foreach ( $items as $item ) {
							...
							$output .= '<option ' . selected( $selected_wpbmcatid, intval( $item->id ), false ) . ' class="cbxlbjs-item-widget" value = ' . intval( $item->id ) . ' data-privacy="' . $item->privacy . '"> ' . $item->cat_name . $show_count_html . '</option>';
						}
        ...
        public static function create_category_html($instance = array()){
	        ...
	        if(intval($instance['allowedit']) && $bookmark_mode == 'user_cat' ){
                ...
                <input class="cbxbmedit-catname" name="catname" value="" />                
                <select class="cbxbmedit-privacy input-catprivacy" name="catprivacy">
                  <option value="1" title="Public Category">'.esc_html__('Public', 'cbxwpbookmark').'</option>
                  <option value="0" title="Private Category">'.esc_html__('Private', 'cbxwpbookmark').'</option>
                </select>
