<?php
	...
	class CBXWPBookmark {
		...
		private function load_dependencies() {
			...
			require plugin_dir_path( dirname( __FILE__ ) ) . 'includes/cbxwpbookmark-tpl-loader.php';

			// Loading Settings Class
			require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-cbxwpbookmark-setting.php';


			require plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-cbxwpbookmark-helper.php';
