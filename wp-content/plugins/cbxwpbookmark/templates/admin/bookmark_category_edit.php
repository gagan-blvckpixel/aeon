						...
						<div class="inside">
							...
							<div class="cbxwpbookmarkadminwrap" id="cbxwpbookmarkadminwrap">
								<div class="cbxwpbookmark-form-section">
									...
									?>
									<form class="cbxwpbookmark-form" method="post" enctype="multipart/form-data" data-busy="0" action="<?php echo admin_url( 'admin.php?page=cbxwpbookmarkcats&view=edit' ); ?>">
										<table class="widefat">
											<tbody>
											<?php if ( $log_id > 0 ) : ?>
												<tr>
													...
													<td>
														<a target="_blank" href="<?php echo esc_url( get_edit_user_link( intval( $user_id ) ) ) ?>"><?php echo $user_id; ?>
														</a>
													</td>
												</tr>
												<tr class="alternate">
										...
										<div class="cbxwpbookmark-form-field">
											<label for="cbxwpbookmark_cat_name"
												   class=""><?php esc_html_e( 'Category Name', 'cbxwpbookmark' ); ?></label><br /> <input type="text" name="cbxwpbookmark_form[cat_name]" id="cbxwpbookmark_cat_name"
																																		  class="regular-text cbxwpbookmark-form-field-input cbxwpbookmark-form-field-input-text cbxwpbookmark_cat_name" required placeholder="<?php esc_html_e( 'Category Name', 'cbxwpbookmark' ); ?>"
																																		  value="<?php echo esc_attr( wp_unslash( $cat_name ) ); ?>" />
										</div>
										<div class="cbxwpbookmark-form-field">
											<label for="cbxwpbookmark_privacy"><?php esc_html_e( 'Status', 'cbxwpbookmark' ); ?></label><br /> <select name="cbxwpbookmark_form[privacy]" id="cbxwpbookmark_privacy">
												<option <?php selected( 1, $privacy, true ); ?> value="1"><?php esc_html_e( 'Public', 'cbxwpbookmark' ); ?></option>
												<option <?php selected( 0, $privacy, true ); ?> value="0"><?php esc_html_e( 'Private', 'cbxwpbookmark' ); ?></option>
											</select>
										...
										?>
										<input type="hidden" name="cbxwpbookmark_cat_addedit" value="1" /> <input type="hidden" name="cbxwpbookmark_form[ajax]" value="0" />
