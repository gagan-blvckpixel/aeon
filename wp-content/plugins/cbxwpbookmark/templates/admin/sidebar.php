	...
	<div class="meta-box-sortables">
		<div class="postbox">
			...
			<div class="inside">
                ...
                ?>
				<p><?php esc_html_e('Support', 'cbxwpbookmark'); ?>: <a href="https://codeboxr.com/contact-us" target="_blank"><span class="dashicons dashicons-external"></span> <?php esc_html_e('Contact Us', 'cbxwpbookmark'); ?></a></p>
				<p><span class="dashicons dashicons-email"></span> <a href="mailto:info@codeboxr.com">info@codeboxr.com</a></p>
				<p><span class="dashicons dashicons-info"></span> <a href="<?php echo esc_url($plugin_url); ?>" target="_blank">Plugin Details</a></p>
				<p><span class="dashicons dashicons-editor-help"></span> <a href="<?php echo  esc_url($doc_url); ?>" target="_blank">Plugin Documentation</a></p>
				<p><span class="dashicons dashicons-star-half"></span> <a href="https://wordpress.org/support/plugin/cbxwpbookmark/reviews/#new-post" target="_blank">Review This Plugin</a></p>
			</div>
		</div>
		<div class="postbox">
				...
				<div id="cbxbookmark_addon_wrap">
					<div class="cbxbookmark_addon cbxbookmark_addon_proaddon">
						<div class="addons-banner-block-item-icon">
							<a href="https://codeboxr.com/product/cbx-wordpress-bookmark/?utm_source=plgsidebarinfo&utm_medium=plgsidebar&utm_campaign=wpfreemium" target="_blank"> <img src="https://codeboxr.com/wp-content/uploads/productshots/445-profile.png"
																												 alt="CBX Bookmark for WordPress" /> </a>
						</div>
						<div class="addons-banner-block-item-content">
							<h3><a href="https://codeboxr.com/product/cbx-wordpress-bookmark/?utm_source=plgsidebarinfo&utm_medium=plgsidebar&utm_campaign=wpfreemium"
					...
					<div class="cbxbookmark_addon cbxbookmark_addon_mycred">
						<div class="addons-banner-block-item-icon">
							<a href="https://codeboxr.com/product/cbx-bookmark-mycred-addon/?utm_source=plgsidebarinfo&utm_medium=plgsidebar&utm_campaign=wpfreemium"
							   target="_blank"> <img src="https://codeboxr.com/wp-content/uploads/productshots/11792-profile.png"
													 alt="CBX Bookmark myCred Addon" /> </a>
						</div>
						<div class="addons-banner-block-item-content">
							<h3><a href="https://codeboxr.com/product/cbx-bookmark-mycred-addon/?utm_source=plgsidebarinfo&utm_medium=plgsidebar&utm_campaign=wpfreemium"
								   target="_blank">CBX Bookmark myCred Addon</a></h3>
							<p>This plugin integrates CBX Bookmark plugin with myCred plugin. Users gets point by bookmarking a post</p>
						</div>
					</div>
				</div>
			</div>
