		...
		public function __construct() {
			if ( defined( 'WPB_VC_VERSION' ) && version_compare( WPB_VC_VERSION, 4.8 ) >= 0 ) {
				if ( function_exists( 'vc_add_shortcode_param' ) ) {
					...
					wp_register_style( 'select2', plugin_dir_url( __FILE__ ) . '../../../assets/select2/css/select2.min.css', array(), CBXWPBOOKMARK_PLUGIN_VERSION );
					wp_register_script( 'select2', plugin_dir_url( __FILE__ ) . '../../../assets/select2/js/select2.min.js', array( 'jquery' ), CBXWPBOOKMARK_PLUGIN_VERSION );
